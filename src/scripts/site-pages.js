...
export const PUBLIC_PAGES = [
  ...
  { file: 'virtual-assistance.html', href: 'virtual-assistance.html', label: 'Virtual Assistance', nav: true, footer: 'Services', priority: '0.85' },
  { file: 'blog.html', href: 'blog.html', label: 'Blog', nav: true, footer: 'Explore', priority: '0.65' },
