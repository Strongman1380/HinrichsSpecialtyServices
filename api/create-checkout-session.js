...
module.exports = async (req, res) => {
    ...
    try {
        ...
        const session = await stripe.checkout.sessions.create({
            ...
            mode: 'subscription',
            success_url: `${req.headers.origin || 'https://hinrichs-specialty-services.vercel.app'}/success.html?session_id={CHECKOUT_SESSION_ID}`,
            cancel_url: `${req.headers.origin || 'https://hinrichs-specialty-services.vercel.app'}/membership.html?canceled=true`,
            metadata: {
                planType: planType,
